...
<div id="wrapper">
	...
	<div class="container">
      ...
      <%if(request.getParameter("msg1")==null){}else{%>
      <%=request.getParameter("msg1")%>
      <%}%>
             </h5></div>
                    
        <form class="form-horizontal" method="post" action="user_login" >
  <div class="form-group">
  ...
  <div class="form-group">
    <label for="newpassword" class="col-lg-5 control-label">Password</label>
    <div class="col-lg-3">
