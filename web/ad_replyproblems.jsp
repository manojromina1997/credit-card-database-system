...
<div class="right_col" role="main">
 ...
 <%
        ...
        %>
        <h4 style="color:blue">
               <form action="Register_Replyproblems" method="post" style="font-size:20px;text-align:left">
                  User Name: <%=resultset.getString(4)%><br>
                   <input type="hidden" name="username" value="<%=resultset.getString(4)%>"/>
                    Email: <%=resultset.getString(2)%><br>
                   <input type="hidden" name="emailid" value="<%=resultset.getString(2)%>"/> 
