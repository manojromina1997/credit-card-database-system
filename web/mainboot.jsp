...
<div id="wrapper">
	...
	<!-- Slider -->
        <div id="main-slider" class="flexslider">
            <ul class="slides">
              <li>
                <img src="lib/img/slides/1.jpg" alt="" />
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<div class="big-cta">
					<div class="cta-text">
						<h2>Welcome to <span>National </span>Bank Home Page</h2>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="col-lg-3">
						<div class="box">
							<div class="box-gray aligncenter">
								...
								<p>
								 Goverment new terms and condition
								</p>
									
							</div>
							<div class="box-bottom">
								<a href="norms.jsp">Learn more</a>
							</div>
						</div>
					</div>
					<div class="col-lg-3">
						<div class="box">
							<div class="box-gray aligncenter">
								...
								<p>
								 Why to use Credit Cards,what are its benefits.
								</p>
									
							</div>
							<div class="box-bottom">
                                                            <a href="benefit.jsp">Learn more</a>
							</div>
						</div>
					</div>
					<div class="col-lg-3">
						<div class="box">
							<div class="box-gray aligncenter">
								...
								<p>
								 Choose a card from a wide range of Options
								</p>
									
							</div>
							<div class="box-bottom">
                                                            <a href="credit.jsp">Learn more</a>
							</div>
						</div>
					</div>
					<div class="col-lg-3">
						<div class="box">
							<div class="box-gray aligncenter">
								...
								<p>
								 Login to know about your account and many more things
								</p>
									
							</div>
							<div class="box-bottom">
                                                            <a href="loginboot.jsp">Learn more</a>
							</div>
						</div>
					</div>
				</div>
