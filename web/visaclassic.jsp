...
<div id="wrapper">
	...
	<div class="container">
		<div class="row">
		            <div class="col-md-12">
        <p id="page">
            <img class="img-responsive" src="pictures/card_visaclassic.jpg" alt="main">
            <br><br>
        ...
        <ul style="font-size:20px">
            ...
            <li>10% off/ cash back through leading online merchants – Jabong.com, redBus, BookMyShow and Freecharge mobile app</li><br>
            <li>Powered by our eDGE Loyalty Rewards Program – earn 2 points for every Rs 200 spent on the card</li><br>
            <li>Dining Delights – 15% off at over 4000 selected restaurants</li><br>
        </ul>
        </div>
			</div>
		</div>
              <div class="middle">
        <a href="credit.jsp" class="btn btn-blue" role="button">Back</a>
        <a href="applyboot.jsp" class="btn btn-blue" role="button">Apply Now</a>
             <br>
        <br>
        <br>
