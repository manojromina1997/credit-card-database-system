			...
			<div class="col-lg-12">
                               <div style="font-size:20px"> 
                                   <ul>
                                       ...
                                       <li>    National Bank was founded on 22 Feb 2016 by a group of students as a Project on CreditCard database system.</li>
                                       <li> For this project we have learned Html ,CSS ,Javascript ,Java ,Advance Java ,hibernate,jdbc ,bootstrap etc .</li>
                                       <li>Our Website provide user to choose for a Creditcard from a Variety of cards.</li>
                                       <li>User can apply for a card by filling their information. </li>
                                       <li>A username and password will be mailed to the user email id</li>
                                       <li>A bank Representative will visit the user place and will verify all the documents.</li>
                                       <li>After vertification user credicard will be delivered.</li>
                                       <li>Now user can use the creditcard and see his details on our website.</li>
