...
<body class="nav-md">
  ...
  <% Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/creditcard","root","12345");
          PreparedStatement pst=conn.prepareStatement("select * from newcustomer");
                  ...
                  <td> <%=resultset.getString(11) %> </td>
                      <td> <%=resultset.getString(12) %> </td>
                          ...
                          <td> <%=resultset.getString(7) %> </td>
                           ...
                           <td> <a href="ad_acceptuser.jsp?id=<%= resultset.getString(8) %>">Accept</a></td>
                  <td><a href="ad_rejectuser.jsp?id=<%= resultset.getString(8) %>">Delete</a></td>
