...
<div class="right_col" role="main">
 ...
 <%
        ...
        %>
        <h4>
               <form class="form-horizontal" action="Delete_newcustomer" method="post">
                   <h4 style="color:blue">Customer Name: <%=resultset.getString(8)%> <%=resultset.getString(9)%></h1>
