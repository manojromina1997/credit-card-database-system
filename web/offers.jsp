        ...
        <div class="left_col scroll-view">
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              ...
              <ul class="nav side-menu">
                  ...
                  <li><a href="inbox.jsp"><i class="fa fa-inbox"></i>Inbox</a>
                </li>
                  <li><a href="profile.jsp"><i class="fa fa-picture-o"></i> Profile </a>
                </li>
                <li><a href="transaction.jsp"><i class="fa fa-list-alt"></i>Transaction</a>
                </li>
                 <li><a href="history.jsp"><i class="fa fa-history"></i>History</a>
                </li>
                  <li><a href="offer.jsp"><i class="fa fa-amazon"></i>Offer</a>
                </li>  
                <li><a href="rewards.jsp"><i class="fa fa-lightbulb-o"></i>Reward</a>
                </li>
