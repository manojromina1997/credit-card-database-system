...
<body class="nav-md">
  ...
  <% Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/creditcard","root","12345");
          PreparedStatement pst=conn.prepareStatement("select * from transaction");
...
%>
              <tr>
                  ...
                  <td> <a href="ad_edittransaction.jsp?id=<%= resultset.getString(6) %>">Edit</a></td>
                  <td><a href="ad_deletetransaction.jsp?id=<%= resultset.getString(6) %>">Delete</a></td>
