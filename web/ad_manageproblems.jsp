...
<body class="nav-md">
  ...
  <% Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/creditcard","root","12345");
          PreparedStatement pst=conn.prepareStatement("select * from problems");
...
%>
              <tr>
                  ...
                  <td> <a href="ad_replyproblems.jsp?id=<%= resultset.getString(4) %>">Reply</a></td>
                  <td><a href="ad_deleteproblems.jsp?id=<%= resultset.getString(4) %>">Delete</a></td>
