...
<div class="right_col" role="main">
        <div class="">
          ...
          <div class="row">
            ...
            PreparedStatement pst=conn.prepareStatement("SELECT * FROM Transaction where username='"+request.getParameter("id")+"'");
 ...
 <%
        ...
        %>
        <h4>
               <form class="form-horizontal" action="Delete_transaction1" method="post">
                   <h4 style="color:blue">Transaction: <%=resultset.getString(6)%> </h1>
