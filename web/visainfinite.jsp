...
<div id="wrapper">
	...
	<div class="container">
		<div class="row">
		            <div class="col-md-12">
        <p id="page">
            <img class="img-responsive" src="pictures/card_visainfinite.jpg" alt="main">
            <br><br>
        ...
        <ul style="font-size:20px">
            ...
            <li> 2 Complimentary Base Fare Flight tickets</li><br>
              <li>Cashback on all Travel spends through the year (Air, Rail, Bus & Cab)</li><br>
                <li>Hotels/Holiday Vouchers worth Rs.10,000</li><br>
