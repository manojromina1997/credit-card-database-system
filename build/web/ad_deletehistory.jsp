...
<div class="right_col" role="main">
        <div class="">
          ...
          <div class="row">
            ...
            PreparedStatement pst=conn.prepareStatement("SELECT * FROM History where username='"+request.getParameter("id")+"'");
 ...
 <%
        ...
        %>
        <h4>
               <form class="form-horizontal" action="Delete_history" method="post">
                   <h4 style="color:blue">History: <%=resultset.getString(6)%></h1>
