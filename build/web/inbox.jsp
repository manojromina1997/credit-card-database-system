...
<body class="nav-md">
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            ...
            <div class="menu_section">
              <ul class="nav side-menu">
                ...
                <li><a href='rewards.jsp?id=<%=username%>'><i class="fa fa-edit"></i>Reward</a>
                </li>
  ...
  <% Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/creditcard","root","12345");
          PreparedStatement pst=conn.prepareStatement("SELECT * FROM replyproblems where username='"+request.getParameter("id")+"'");
