...
<%
  ...
  <% Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/creditcard","root","12345");
          PreparedStatement pst=conn.prepareStatement("SELECT * FROM customer where username='"+request.getParameter("id")+"'");
          ...
          <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                    <form class="form-horizontal"  action="Register_Problems1" method="post" >
