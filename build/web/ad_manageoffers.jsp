...
<body class="nav-md">
  ...
  <% Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/creditcard","root","12345");
          PreparedStatement pst=conn.prepareStatement("select * from offers");
...
%>
              <tr>
                  ...
                  <td> <a href="ad_editoffers.jsp?id=<%= resultset.getString(3) %>">Edit</a></td>
                  <td><a href="ad_deleteoffers.jsp?id=<%= resultset.getString(3) %>">Delete</a></td>
