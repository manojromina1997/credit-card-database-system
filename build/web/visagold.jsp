...
<div id="wrapper">
	...
	<div class="container">
		<div class="row">
		            <div class="col-md-12">
        <p id="page">
            <img class="img-responsive" src="pictures/card_visagold.jpg" alt="main">
            <br><br>
        ...
        <ul style="font-size:20px">
             ...
             <li>Get 25% Cashback on all movie ticket purchases</li><br>
            <li>Get 10 times more Reward Points on Dining on weekends</li><br>
            <li>Get 5 times more Reward Points on Shopping on weekends</li><br>
            <li>Complimentary Lounge Access at select Airports & Fuel Surcharge Waiver</li><br>
        </ul>
        </div>
			</div>
		</div>
